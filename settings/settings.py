class settings():
    ...
    AVITO_ITEM_FOOTER = """
    .//div[
    .//span[@data-marker='item-view/item-id'] and
    .//span[@data-marker='item-view/item-date'] and
    ...
    # styles-item-price-sub-price-A1IZy
    # ".//div[@class='XrMmQ']/p/span"

    # AVITO_SUBPRICE_XPATH = """
    #     .//div[.//span[contains(text(), '₽') and 
    #     (contains(text(), 'в месяц') or contains(text(), 'за м²'))]]
    # """
